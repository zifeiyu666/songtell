---
title: "I Couldn't Find a Valentine's Day Gift That Felt Personal, So I Built One"
description: "Why I built SendTheSong after struggling to find a personal Valentine's Day gift, and how AI turns real memories into songs, videos, and lyric art."
slug: why-i-built-send-the-song
tags: "SendTheSong,founder story,AI custom song,Valentine's Day gift,personalized music gift"
...
<img
  src="/steps/hero.webp"
  alt="SendTheSong homepage introducing a free personalized song gift preview"
/>
...
The first step is deliberately simple: choose who the song is for and why you are making it. The occasion gives the AI context, but it does not dictate the story.

<img
  src="/steps/step-1-select-occasion-and-recipient.webp"
  alt="SendTheSong recipient and occasion selection step for a personalized song"
/>

Next, you choose a musical direction. Genre, mood, vocal style, and language give the song a starting point. You can change them later if the first combination does not fit the person you have in mind.

<img
  src="/steps/step-2-select-music-style.webp"
  alt="SendTheSong music style step with genre, mood, vocal, and language controls"
/>
...
<img
  src="/steps/step-3-generate-story.webp"
  alt="Story editor in SendTheSong showing a detailed relationship memory prepared for lyric generation"
/>
...
<img
  ...
  alt="Editable custom song lyrics with controls for rewriting selected lines or creating a new version"
/>
...
<img
  src="/steps/song-generation-result.webp"
  alt="Finished custom song page with private share link, download, wall art, and music video options"
/>
...
<img
  src="/steps/pricing.webp"
  alt="SendTheSong pricing options built around free previews and paying for a finished song"
/>
...
<img
  src="/steps/lyric-wall-art.webp"
  alt="Lyric Wall Art Studio with printable record-style custom song artwork and editing controls"
/>
...
<img
  src="/steps/music-video.webp"
  alt="Music Video Studio with lyric video templates, backgrounds, and a Remotion preview"
/>
