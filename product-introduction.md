...
Turn any memory, love note, or celebration into a personalized AI song, lyric poster, and music video made to share.
...
Product Hunt official launch guide reference: https://www.producthunt.com/launch/preparing-for-launch
...
| Promo | Unlimited free 60-second previews, no credit card required |
| Free Trial Details | Create unlimited free 60-second song previews before paying. No credit card is required. Each preview lets users hear the song direction, lyrics, vocal feel, and overall style, then refine the story or music prompt until it feels right. The full-length song, downloads, music video, and lyric wall art are unlocked only when the user chooses to upgrade. |
...
| YouTube | https://www.youtube.com/@sendthesong |
...
- Story-to-lyrics workflow for birthdays, anniversaries, weddings, holidays, family memories, long-distance relationships, thank-you gifts, and memorial moments.
- Unlimited free 60-second previews first, no credit card required.
- Lyrics and style refinement before unlocking the full song.
- Optional music video templates for easy sharing.
- Printable lyric wall art for a keepsake that can live beyond the audio file.

I would love feedback on three things:

1. Does the product positioning feel clear?
2. Does the gift flow feel simple enough for non-musicians?
3. What would make the final song feel more personal or more giftable?

Thanks for checking it out. I will be here all day answering questions and taking notes.
...
- 支持从故事到歌词的创作流程，适合生日、纪念日、婚礼、节日、家庭回忆、异地关系、感谢礼物和纪念场景。
- 先无限次免费生成 60 秒预览，不需要信用卡。
- 解锁完整歌曲前，可以继续调整歌词和音乐风格。
- 可制作适合分享的音乐视频。
- 可生成可打印的歌词海报，让礼物不只停留在音频文件里。

我特别想听听大家对这三点的反馈：

1. 产品定位是否清楚？
2. 对非音乐用户来说，整个礼物制作流程是否足够简单？
3. 还有什么功能会让最终歌曲更私人、更像一份真正的礼物？

谢谢大家体验。我会在发布当天持续回复问题和记录反馈。
...
Would love your feedback on the gift flow and song quality:

TODO: add Product Hunt URL
...
欢迎帮我们看看礼物制作流程和歌曲质量，还有哪些地方可以做得更好：
...
We are looking for feedback from makers, musicians, gift-givers, and anyone curious about AI-assisted creative products.
...
我们很希望听到来自 maker、音乐创作者、礼物购买者，以及关注 AI 创意产品的朋友们的反馈。
...
If you have a minute, we would love your feedback on the product page, song creation flow, and overall gift experience.

Product Hunt page: TODO: add Product Hunt URL
...
如果你有时间，欢迎帮我们看看 Product Hunt 页面、歌曲生成流程和整体礼物体验，并留下反馈。

Product Hunt 页面：TODO: add Product Hunt URL
...
EN: Thank you for checking it out and sharing this. I appreciate the specific feedback, especially around the gift flow. I am collecting launch-day notes and will use this to prioritize the next round of improvements.

ZH: 谢谢你体验并分享反馈，尤其是关于礼物流程的具体建议。我会把发布当天的反馈整理起来，用来决定下一轮优化优先级。
...
EN: Quality is one of the main areas we are improving. The current flow focuses on making the story, lyrics, vocal direction, and final gift experience feel connected. If you notice anything specific in the song output, I would love to hear it.

ZH: 歌曲质量是我们持续优化的重点。当前流程主要关注故事、歌词、演唱方向和最终礼物体验之间的连贯性。如果你在歌曲输出里发现具体问题，非常欢迎告诉我。

### Privacy

EN: Personal stories can be sensitive, so privacy matters a lot for this product. Users control what they enter, what they unlock, and how they share the finished song.

ZH: 这类产品会涉及比较私人的故事，所以隐私非常重要。用户可以控制自己输入什么内容、是否解锁完整歌曲，以及最终如何分享。

### Feature Requests

EN: That is a helpful suggestion. I am grouping feature requests from launch day, and this fits directly into the personalization side of the product.

ZH: 这个建议很有帮助。我会把发布当天的功能请求集中整理，你提到的方向和产品的个性化能力很相关。

### Upvote Requests

EN: Thanks for asking how to help. The most useful thing is honest feedback in the Product Hunt comments: what feels clear, what feels confusing, and what would make the product more useful.

ZH: 谢谢你问怎么支持。最有帮助的是在 Product Hunt 评论区留下真实反馈：哪些地方清楚、哪些地方困惑、什么功能会让产品更有用。

## 6. Visual Asset Checklist

| Asset | Path | Use |
| --- | --- | --- |
| Logo / thumbnail source | `public/logo.png` | Product Hunt thumbnail or brand avatar |
| Main Open Graph image | `public/og.jpg` | Gallery candidate, social preview |
| Personalized song product image | `public/images/products/prd3.webp` | Gallery candidate |
| Music video gift product image | `public/images/products/prd1.webp` | Gallery candidate |
| Digital wall art product image | `public/images/products/prd2.jpg` | Gallery candidate |
| Dynamic wave radio template | `public/images/features/dynamic-wave-radio-template.webp` | Gallery candidate |
| Minimal vinyl record template | `public/images/features/minimal-vinyl-record-template.webp` | Gallery candidate |
| Photo lyric music video template | `public/images/features/photo-lyric-mv-template.webp` | Gallery candidate |

Recommended Product Hunt gallery order:

1. `public/og.jpg`
2. `public/images/products/prd3.webp`
3. `public/images/products/prd1.webp`
4. `public/images/products/prd2.jpg`
5. `public/images/features/photo-lyric-mv-template.webp`

Notes:

- Product Hunt requires at least 2 gallery assets.
- Demo video: not planned for this launch.
- If Product Hunt crops the logo poorly, prepare a square 2400 x 2400 version using `public/logo.png` as the source.
...
- [ ] Confirm paid unlock flow works in production.
- [ ] Confirm mobile experience is usable from the Product Hunt in-app browser.
- [ ] Upload at least 2 gallery assets.
- [ ] Use no demo video for this launch.

### Launch Day

- [ ] Publish maker comment immediately after launch.
- [ ] Share X/Twitter post with Product Hunt URL.
- [ ] Share LinkedIn post with Product Hunt URL.
- [ ] Share email or community announcement.
- [ ] Ask for feedback and comments only.
- [ ] Do not ask directly for upvotes.
- [ ] Monitor comments for product positioning, quality, pricing, privacy, and feature request themes.
- [ ] Save useful feedback for post-launch improvements.

### After Launch

- [ ] Add Product Hunt badge or launch mention to the site if useful.
- [ ] Summarize feedback themes.
- [ ] Prioritize improvements around unclear positioning, weak song quality signals, confusing flow, or missing gift-sharing features.
- [ ] Reuse top-performing launch copy in future landing page, SEO, ads, or email tests.

## 8. Quick Validation

- Product Hunt tagline: `Turn your memories into personalized AI songs`
- Tagline character count: 45
- Product Hunt description character count: 318
- Local assets listed above exist in the repository.
- No discount code is included.
- No demo video script is included.
- Unknown fields are marked with TODO.
